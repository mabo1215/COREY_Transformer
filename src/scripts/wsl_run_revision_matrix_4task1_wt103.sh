...
export LM_MAX_SAMPLES=1
export PPL_MAX_SAMPLES=1
...
for policy in off static corey; do
  ...
  export OUTPUT_DIR="src/outputs/revision_matrix_4task1_wt103_policy_${policy}"
  echo "[revision-matrix] running policy=$policy output=$OUTPUT_DIR"
