#!/usr/bin/env bash
# 20-sample three-policy matrix (off / static / corey)
# 4 LongBench tasks x 3 models x 3 scheduler policies; wikitext103 only; offline mode
set -euo pipefail
...
export LM_DATASETS="wikitext103"
...
export LM_MAX_SAMPLES=20
export PPL_MAX_SAMPLES=20
...
echo "[revision-matrix-20] all policies completed"
